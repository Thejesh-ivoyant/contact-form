...
function ContactSection() {
  return (
    <section className="flex flex-col items-center pt-12 text-base font-medium text-center text-white bg-green-900 w-[45%] ">
      ...
      <ImageWithAlt src="https://cdn.builder.io/api/v1/image/assets/TEMP/0f0cd2b0fa7ed8b81ab533956f64f347bf9d453ad9e4b96b3e6f16860fac2130?apiKey=9e16588387084fb2a9a51a1b99489136&" alt="Visualization of services offered" />
    </section>
  );
}
