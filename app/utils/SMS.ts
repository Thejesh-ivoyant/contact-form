...
export const SMS = async (c_code: string, phone_no: string, name: string) => {
  ...
  const smsBody = `${name}, it was great meeting with you at NMSDC Annual conference & Exchange 2024 in Atlanta, GA. We're excited to connect and partner with you. You can reach me directly at:\n\nSonya Beredimas\nsonya@ivoyant.com \n+1 (678) 674 3937\nhttps://www.linkedin.com/in/sonya-b-235372120\nhttps://www.ivoyant.com`;
